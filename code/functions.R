...
graph_weir_vs_sonar_no_ylabel <- function(data, linear_model, this_year, this_period, this_species) { 
...
pvalues_lm_graph_ws_no_ylabel <- function(data = data_wide_weir_sonar60, this_species, this_period, this_year){
  #this_species <- "sockeye"
  #this_year <- 2016 
  #this_period <- "sixty_minute"
  ...
  # Graph regression and put in figure file
  (graph <- graph_weir_vs_sonar_no_ylabel(data_wide, linear_model, this_year, this_period, this_species))
  #ggsave(paste0("figures/", this_species, this_period, this_year, "weir_sonar.png"), dpi=600, height=6, width=6, units="in")
